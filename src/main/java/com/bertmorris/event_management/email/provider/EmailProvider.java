...
public class EmailProvider {
    ...
    public void fullSyncEmails(String oboToken, Long userId) {
        ...
        } catch (com.microsoft.kiota.ApiException apiEx) {
            logger.error("Graph API error syncing emails: status={} message={}", apiEx.getResponseStatusCode(), apiEx.getMessage());
            throw new RuntimeException("Error syncing emails", apiEx);
        } catch (Exception e) {
            logger.error("Unexpected error syncing emails", e);
            throw new RuntimeException("Error syncing emails", e);
        }
    }
}